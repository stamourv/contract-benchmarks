#lang racket/gui
;;; Science Collection
;;; random-distributions/t-distribution-graphics.rkt
...
;;; -------------------------------------------------------------------
;;;
;;; This code implements graphics for t-distributions.
;;;
;;; Version  Date      Description
;;; 0.1.0    09/18/04  This is the initial release of the t-
...
;;; t-distribution-plot: real -> 2d-view%
(define (t-distribution-plot nu)
  (plot (list (function (lambda (x) (t-distribution-pdf x nu))
                        #:label "y = pdf(x)"
                        #:color "red")
              (function (lambda (x) (t-distribution-cdf x nu))
                        #:label "y = cdf(x)"
                        #:color "blue"))
        #:x-min -6 #:x-max 6 #:x-label "x"
        #:y-label "Density"
