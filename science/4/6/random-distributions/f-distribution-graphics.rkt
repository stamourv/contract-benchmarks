#lang racket/gui
;;; Science Collection
;;; random-distributions/f-distribution-graphics.rkt
...
;;; -------------------------------------------------------------------
;;;
;;; This code implements graphics for f-distributions.
;;;
;;; Version  Date      Description
;;; 0.1.0    09/17/04  This is the initial release of the f-
...
(define (f-distribution-plot nu1 nu2)
  (plot (list (function (lambda (x) (f-distribution-pdf x nu1 nu2))
                        #:label "y = pdf(x)"
                        #:color "red")
              (function (lambda (x) (f-distribution-cdf x nu1 nu2))
                        #:label "y = cdf(x)"
                        #:color "blue"))
        #:x-min 0.0 #:x-max 12.0 #:x-label "x"
        #:y-label "Density"
