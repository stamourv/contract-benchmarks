(module pict scheme/base
  (require (rename-in "texpict/mrpict.rkt"
                      [hline t:hline]
                      [vline t:vline]
                      [frame t:frame])
           (rename-in "texpict/utils.rkt"
                      [pin-line t:pin-line]
                      [pin-arrow-line t:pin-arrow-line]
                      [pin-arrows-line t:pin-arrows-line])
           (only-in "draw/main.rkt" dc-path% make-bitmap bitmap% bitmap-dc%)
  ...
  (provide hline vline
           ...
           (except-out (all-from-out "texpict/mrpict.rkt")
           ...
           (except-out (all-from-out "texpict/utils.rkt")
